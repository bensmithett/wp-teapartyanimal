...
?>
	<form method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
		<label for="s" class="is-visuallyhidden screen-reader-text"><?php _ex( 'Search', 'assistive text', 'teapartyanimal' ); ?></label>
		...
		<input type="submit" class="is-visuallyhidden submit" id="searchsubmit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'teapartyanimal' ); ?>" />
	</form>
